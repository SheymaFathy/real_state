            ...
            child: Container(
              ...
              child: SingleChildScrollView(
                child: Column(
                  ...
                  children: [
                     TitleText(title: loc.translate("fliterd_result")),
                    const SizedBox(height: 16),

                    CustomTextField(
                      label: loc.translate("min_price"),
                      controller: minPrice,
                      paddingTop: 10,
                      isPassword: false,
                      icon: Icons.money,
                    ...
                    CustomTextField(
                      label: loc.translate("number_of_rooms"),
                    ...
                    CustomTextField(
                      label: loc.translate("number_of_bathrooms"),
